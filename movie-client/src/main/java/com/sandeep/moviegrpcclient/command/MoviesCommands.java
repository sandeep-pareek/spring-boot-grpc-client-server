...
import com.sandeep.moviegrpcclient.client.MovieResponse;
import com.sandeep.moviegrpcclient.client.MovieServiceGrpcClient;
...
public class MoviesCommands {
    ...
    public MoviesCommands(MovieServiceGrpcClient movieServiceGrpcClient) {
        this.movieServiceGrpcClient = movieServiceGrpcClient;
    }
